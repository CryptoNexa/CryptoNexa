"""
Django settings for CryptoNexa project.
...
SECRET_KEY = 'django-insecure-26d&$(k9d+fxjva2z1=$-b7em=f_--&=**fcwv305h3triqda^'
...
WSGI_APPLICATION = 'CryptoNexa.wsgi.application'
